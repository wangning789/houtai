    ...
    <el-card class="box-card">
      <template>
        <el-table
          ...
          border
          default-expand-all
          :tree-props="{children: 'children', hasChildren: 'cat_level'}"
        >
          <el-table-column prop="date" label="#" type="index"  width="80"  :tree-props="{children: 'children', hasChildren: 'cat_level'}"> </el-table-column>
