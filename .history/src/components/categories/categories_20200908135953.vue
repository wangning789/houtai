<template>
  <div>
    <el-card class="box-card">
      ...
      <!-- 点击添加分类 -->
       <el-dialog title="编辑分类" :visible.sync="dialog" width="30%" :before-close="handleClose">
        <el-form :model="roufrom" :rules="rules" label-width="100px" class="demo-ruleForm">
          <el-form-item label="编辑名称" prop="name">
...
export default {
  ...
  methods: {
    ...userActions(["getcategoriesTwo", "getboydlt", "geteaitfenlei"]),
    handleClose(done) {
