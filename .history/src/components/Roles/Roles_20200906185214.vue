...
>
 ...
 <span slot="footer" class="dialog-footer">
        <el-button @click="dialoging=false">取 消</el-button>
        <el-button type="primary" @click="clidbhhjas">确 定</el-button>
</span>
 </el-dialog>

    <!-- <Tree @handleClosetree="handleClosetree" :ids="ids" :tree="tree" :dialoging="dialoging"></Tree> -->
  </div>
</template>
