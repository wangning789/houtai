  ...
  <!-- 编辑弹出框 -->
    ...
    >
      <el-form
        ...
        :rules="rules"
      >
        <el-form-item label="职位名称" prop="rolel">
    ...
    >
      <el-form
        ...
        :rules="addrules"
      >
        <el-form-item label="职位名称" prop="addrolel">
          <el-input v-model="form.addrole"></el-input>
        </el-form-item>
         <el-form-item label="角色描述" prop="describe">
          <el-input v-model="form.adddescribe"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...userActions(["getrole", "getroleid", "getdeleterole",'getroleodr','getfenlei','getlodi']),
