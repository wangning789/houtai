          ...
          >
            <template slot-scope="scope">
              ...
              <template v-if="item.name">
                <el-button type="primary" @click="eitclick(scope.row)">编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    //点击弹出编辑框
    eitclick(val) {
      this.ruleForm.name = val.attr_name;
    ...
    handleInputConfirm(props) {
      ...
      if (inputValue) {
        ...
        this.sel[props.$index].attr_vals.push('inputValue')
        // this.tag.push('516');
      }
      // console.log(inputValue)
      // console.log(this.sel[props.$index].attr_vals)
      //  console.log(this.$store.state.commodity.sel)
  ...
  mounted() {
    this.$store.state.commodity.sel = [];
    // console.log('123',this.$store.state.commodity.sel)
