    ...
    <el-card class="box-card">
      ...
      <el-table :data="sel" style="width: 100%">
        <template v-for="item in msg">
          ...
          <el-table-column v-if="item.type==='expand'" :key="item.label" type="expand"></el-table-column>
          <el-table-column v-if='item.label===false' :key="item.label" :align='item.align ' :label='item.label' prop=""></el-table-column>
        </template>
      </el-table>
    </el-card>
  </div>
