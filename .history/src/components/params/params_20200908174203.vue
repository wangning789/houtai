    ...
    <el-card class="box-card">
      ...
      <el-table :data="sel" style="width: 100%">
        <template v-for="item in msg">
          <el-table-column  v-if="item.type"  :key="item.label"  :align='item.align ' :label='item.label' :type="item.type"></el-table-column>
          <el-table-column v-else :key="item.label" :align='item.align ' :label='item.label' prop=""></el-table-column>
          <el-table-column v-if="item.type==='expand'"  :label='item.label' :key="item.label" :type="item.type"></el-table-column>
