  ...
  methods: {
   ...
   clicknext(){
       if(this.activeName==='基本信息'&&this.active===0){
           ...
           this.active=1
           this.show=1
       }else if(this.activeName==='商品参数'&&this.active===1&&this.show===1){
           this.activeName='商品属性'
           this.active=2
           this.show=2
       }else if(this.activeName==='商品属性'&&this.active===2&&this.show===2){
           this.activeName='商品图片'
           this.active=3
           this.show=3
        }else if(this.activeName==='商品图片'&&this.active===2&&this.show===2){
