    ...
    <el-dialog title="编辑商品" :visible.sync="adduser" width="30%">
      <el-form ref="addform" :model="form" label-width="80px" :rules="rules">
        <el-form-item label="商品名称" prop="name">
          <el-input  style="width: 300px" controls-position="right" v-model="form.name"></el-input>
        </el-form-item>
        <el-form-item label="商品价格" prop="price">
          <el-input-number  controls-position="right"  :controls='controls'  v-model="form.price"></el-input-number>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...userActions(["getdata", "getcategories",'getbianji']),
