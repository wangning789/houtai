...
<el-card>
  ...
  <el-input placeholder="请输入内容" v-model="content" class="input-with-select" prop="pass" autocomplete="off">
...
const { mapState: userState, mapActions: userActions } = userModule;
 export default {
  ...
  // 编辑输入框验证状态设置
   ...
   methods: {
      ...userActions(["getusers","getusername","getaddusers",'getdelete',"getinformation"]),
    ...
    fenbution(index,item){
      this.getinformation({id:item.id})
