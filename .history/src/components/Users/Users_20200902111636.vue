...
<el-dialog title="添加用户" :visible.sync="adduser" width="30%" >
  ...
  <el-form-item label="用户名" prop="addusername" >
    <el-input v-model="addform.addusername" :disabled="true"></el-input>
  </el-form-item>
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button type="primary" @click="Confirmedit('addform')">确 定</el-button>
  </span>
</el-dialog>
...
const { mapState: userState, mapActions: userActions } = userModule;
 export default {
  ...
  // 编辑输入框状态设置
   ...
   methods: {
      ...userActions(["getusers","getusername"," getaddusers","getaddusers"]),
