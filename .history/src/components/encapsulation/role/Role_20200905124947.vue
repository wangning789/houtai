              ...
              <div style="display:flex  ">
                <div class="onelabel">
                  <el-tag
                    ...
                    @close="handleClose(item.authName)"
                    ...
                    <div style="display:flex">
                      <div class="twolabel">
                        <el-tag
                          ...
                          type="success"
                          :disable-transitions="false"
                          @close="handleClose(item1.authName)"
                        >{{item1.authName}}</el-tag>
                      </div>
                      <div v-if="item1.children&&item1.children.length>0" display:flex>
                        <div v-for="item2 in item1.children" :key="item2.id" style="display:flex">
