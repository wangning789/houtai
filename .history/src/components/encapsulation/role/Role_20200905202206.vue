<template>
  <div>
    <el-card class="box-card">
       <el-button @click="add-to">添加</el-button>
...
export default {
  ...
  methods: {
    ...
    handleClose(item,scope) {
      this.$emit("handleClose",item,scope.row)
      // console.log('789',scope.row);
    }
  },
  mounted() {},
  watch: {},
